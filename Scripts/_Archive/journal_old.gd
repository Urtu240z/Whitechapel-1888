...
# ================================================================
# INPUT — solo navegación de páginas
# La tecla "stats" (Q) la gestiona GameManager exclusivamente
# ================================================================
...
# ================================================================
# ABRIR / CERRAR — API pública, llamada desde GameManager
# ================================================================
...
func open() -> void:
	...
	# Player freeze gestionado por GameManager
...
func close() -> void:
	...
	is_open = false
	visible = false
	# Player restore gestionado por GameManager
