extends Area2D
class_name NPCCompanionConversation

# ============================================================================
# NPC COMPANION CONVERSATION
# Detecta al jugador en rango y registra la companion en InteractionManager.
# Idéntico a NPCClientConversation.
# ============================================================================
